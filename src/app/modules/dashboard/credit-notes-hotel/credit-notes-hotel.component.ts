...
declare var $:any
@Component({
  selector: 'app-credit-notes-hotel',
  templateUrl: './credit-notes-hotel.component.html',
  styleUrl: './credit-notes-hotel.component.css'
})
export class CreditNotesHotelComponent {
  ...
  SearchSubmit()
  {
   this.Searchsubmitted = true;
    ...
    this.dashboardservice.CreditNotesList(this.SearchForm.value,'hotel').subscribe(data=>{
      let resp:any=data;
      ...
      { 
         ...
         this.displayedColumns=[ 'BookingRefNumber','PassengerName','AccRefNumber','PaymentMode','ActionType','TotalPrice','HotelName','BookingStatus','PaymentStatus','City','View'];
  ...
  View(data:any){
    let req={
          "BookigId": data.HotelBookingId,
          "SearchTokenId": data.TtsSearchToken,
          "HtmlType": "Voucher",
          "UserType": "WebPartner",
          "ViewService": "View",
          "WithAgencyDetail": "1",
      ...
      this.router.navigate(['dashboard/view-credit-notes'],navigationExtras);
  }
