...
export class CreditNotesComponent {
  ...
  SearchSubmit()
  {
   this.Searchsubmitted = true;
    ...
    this.dashboardservice.CreditNotesList(this.SearchForm.value,'flight').subscribe(data=>{
      let resp:any=data;
      ...
      { 
         ...
         this.displayedColumns=[ 'BookingRefNumber','Name','AccRefNumber','PaymentMode','ActionType','TotalPrice','Origin','Destination','AirlineCode','TicketNumber','Pnr','View'];
  ...
  View(data:any){
    let req={
          "traveller_ref_number": data.traveller_ref_number,
          "booking_ref_number": [
