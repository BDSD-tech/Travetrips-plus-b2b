...
@Component({
  selector: 'app-manage-amendments',
  templateUrl: './manage-amendments.component.html',
  styleUrls: ['./manage-amendments.component.css']
})
export class ManageAmendmentsComponent implements OnInit {
  ...
  SearchSubmit()
  {
    ...
    this.dashboardservice.AmendmentsList(this.SearchForm.value,'flight').subscribe(data=>{
      let resp:any=data;
      ...
      { 
         ...
         this.displayedColumns=['created','Departure','AmendmentId','BookingRefNumber','AmendmentStatus','WebPartner','staff_name','AmendmentType','WebPartnerRemark','Sector','Carrier'];
